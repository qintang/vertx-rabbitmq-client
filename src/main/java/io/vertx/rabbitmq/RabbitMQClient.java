...
public interface RabbitMQClient {
   ...
   */
  @Deprecated
  void basicConsume(String queue, String address, Handler<AsyncResult<String>> resultHandler,Handler<AsyncResult<JsonObject>> resultParseErrorHandler);
   ...
   */
  @Deprecated
  void basicConsume(String queue, String address, boolean autoAck, Handler<AsyncResult<String>> resultHandler,Handler<AsyncResult<JsonObject>> resultParseErrorHandler);
   ...
   */
  @Deprecated
  void basicConsume(String queue, String address, boolean autoAck, Handler<AsyncResult<String>> resultHandler, Handler<Throwable> errorHandler,Handler<AsyncResult<JsonObject>> resultParseErrorHandler);
  ...
  /**
   * Instead of using this and {@link #basicConsume(String, String, Handler,r)} method,
   * {@link #basicConsumer(String, QueueOptions, Handler)} and {@link RabbitMQConsumer#cancel(Handler)} instead
   * <p>
   * This method should be called when you want to cancel consumption from a queue,
   * started by calling {@link #basicConsume(String, String, Handler,)}.
